...
const AboutPage: React.FC<{ isLandingSection?: boolean }> = ({ isLandingSection = false }) => {
    ...
    const containerClasses = isLandingSection ? 'py-0 max-w-5xl mx-auto' : 'max-w-5xl mx-auto py-16 px-6'; 
    // Increased heading sizes
    const headingClass = "text-4xl md:text-5xl font-bold text-white tracking-tight mb-6";
    // Increased subheading size
    const subHeadingClass = "text-lg text-text-secondary max-w-3xl mx-auto leading-relaxed";
    ...
    return (
        <div className={`animate-fade-in ${containerClasses} space-y-16`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center bg-bg-surface/40 p-8 rounded-2xl border border-white/5 backdrop-blur-sm"> 
                <div>
                    <h2 className="text-2xl font-bold text-white mb-4">The Context Gap</h2>
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex items-start gap-3">
                            <div className="mt-1.5 p-0.5 bg-red-500/10 rounded text-red-400"><div className="w-2 h-2 bg-red-500 rounded-full"></div></div>
                            <p className="text-base text-text-secondary"><strong className="text-white">Generic AI:</strong> Ignores idioms and cultural taboos.</p>
                        </div>
                        <div className="flex items-start gap-3">
                            <div className="mt-1.5 p-0.5 bg-accent/10 rounded text-accent"><div className="w-2 h-2 bg-accent rounded-full"></div></div>
                            <p className="text-base text-text-secondary"><strong className="text-white">AfriTranslate:</strong> Analyzes intent and cultural norms.</p>
                        </div>
                    </div>
                </div>
            ...
            {/* 3. Three Pillars */}
            <div>
                <h2 className="text-2xl font-bold text-center text-white mb-10">Built on Three Pillars</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="bg-bg-surface p-8 rounded-2xl border border-border-default hover:border-accent/30 transition-colors group">
                        ...
                        <h3 className="text-lg font-bold text-white mb-3">Linguistic Diversity</h3>
                    ...
                    <div className="bg-bg-surface p-8 rounded-2xl border border-border-default hover:border-accent/30 transition-colors group">
                        ...
                        <h3 className="text-lg font-bold text-white mb-3">Real-Time Adaptation</h3>
                        <p className="text-base text-text-secondary leading-relaxed">
                    ...
                    <div className="bg-bg-surface p-8 rounded-2xl border border-border-default hover:border-accent/30 transition-colors group">
                        ...
                        <h3 className="text-lg font-bold text-white mb-3">Ethical AI</h3>
                        <p className="text-base text-text-secondary leading-relaxed">
