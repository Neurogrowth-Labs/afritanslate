            ...
            <div className="hidden md:flex items-center gap-3 pl-4 border-l border-white/5 h-8">
                {(currentUser.plan !== 'Entreprise') && (
                    <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 bg-accent/10 border border-accent/20 text-accent text-[10px] font-bold rounded-full hover:bg-accent hover:text-black transition-all shadow-sm mr-2"
                    >
